...
const courses = [
  {
    ...
    path: "Graphic", // URL-friendly path
  },
  {
    title: "3D Animation",
    description:
    ...
    path: "Animation", // URL-friendly path
  },
];
      ...
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-12 relative z-10">
        {courses.map((course, index) => (
          ...
          >
            ...
            <Link
              to={`/${course.path}`}
              className="mt-4 bg-[#f5979a] text-white px-4 py-2 rounded-lg hover:bg-[#e58088] transition-all duration-300"
            >
              Details
            </Link>
          </div>
